...
package com.world.wen.view.fragment.widget;
...
import com.world.wen.util.DensityUtil;
...
//		this.getWindow().setType(WindowManager.LayoutParams.TYPE_SYSTEM_ALERT);
	...
	public void showContent(int res) {
		tvContent.setVisibility(View.VISIBLE);
		tvContent.setText(getContext().getResources().getText(res));
	}
